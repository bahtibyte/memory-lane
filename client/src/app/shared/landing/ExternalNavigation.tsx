...
export default function ExternalNavigation({ links = { home: true, contributors: true, github: true } }: ExternalNavigationProps) {
  const navigationLinks: NavigationLink[] = [
    {
      enabled: links.home ?? true,
      href: "/",
      label: "HOME",
      icon: (
    ...
    {
      enabled: links.contributors ?? true,
      href: "/contributors",
      label: "CONTRIBUTORS",
      icon: (
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
